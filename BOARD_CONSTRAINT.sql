...
CREATE TABLE user (
    ...
    profile_image VARCHAR(500) NOT NULL DEFAULT 'https://images.christiantoday.co.kr/data/images/full/349598/image.jpg?w=654'
);
...
CREATE TABLE comment (
    ...
    write_datatime DATETIME NOT NULL DEFAULT now(),
    FOREIGN KEY (board_number) REFERENCES board (board_number),
    FOREIGN KEY (user_email) REFERENCES user (email)
);